...
const SalesOverview: React.FC<SalesOverviewProps> = ({ data }) => {
  ...
  const axisColor = isDark ? '#94a3b8' : '#94a3b8'; // Keeping same for now, or '#64748b' for light
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
            <div className="flex items-center gap-2 mb-1">
                <span className="bg-gray-100 dark:bg-gray-700 p-1.5 rounded-md"><ArrowUpDown size={14} className="text-gray-600 dark:text-gray-300" /></span>
