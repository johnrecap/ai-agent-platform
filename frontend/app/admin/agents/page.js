...
export default function AgentsPage() {
    ...
    const txt = {
        ...
        difyAppId: language === 'ar' ? 'معرف تطبيق Dify' : 'Dify App ID',
        providerType: language === 'ar' ? 'نوع المزود' : 'Provider Type',
        ...
        embed: language === 'ar' ? 'احصل على كود التضمين' : 'Get Embed Code',
    };
