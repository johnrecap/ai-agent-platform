 ...
 * Table showing list of integrations with status
 */

import { Layers, CheckSquare, Square } from 'lucide-react';
import { integrationsData } from '@/constants/newDashboardData';
                            ...
                            <tr key={item.id} className="group hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="py-4">
                                    <div className="flex items-center gap-3">
                                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold ${item.name === 'Stripe' ? 'bg-indigo-600' :
